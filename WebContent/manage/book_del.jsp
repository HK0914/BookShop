  ...
  <tr>
    ...
    <td align="center" valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td width="1070" align="center" background="images/manage_leftTitle_mid.GIF" class="word_white"><b>删除图书信息</b></td>
	...
	<!---->
			    ...
			    <table width="94%"  border="0" align="right" cellpadding="-2" cellspacing="-2" bordercolordark="#FFFFFF">
                  ...
                  <tr>
                    ...
                    <td>&nbsp; <%if(newbook==0){out.print("不是新品");}
					else{out.print("是新品");}
					%></td>
                    <td>&nbsp;是否特价：</td>
                    <td><%if(sale==0){out.print("不是特价图书");}
					else{out.print("是特价图书");}
					%></td>
                  </tr>
                  <tr>

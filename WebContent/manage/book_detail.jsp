...
if(ID>0){
	ResultSet rs=conn.executeQuery("select ID,BookName,Introduce,nowprice,picture from tb_book where ID="+ID);
	int bookID=-1;
	String bookName="";
	String introduce="";
  ...
  <tr>
    ...
    <td align="center" valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td width="1070" align="center" background="images/manage_leftTitle_mid.GIF" class="word_white"><b>图书详细信息</b></td>
    ...
    <table width="96%" height="153"  cellpadding="0" cellspacing="0" border="1" bordercolor="#FFFFFF" bordercolordark="#FFFFFF" bordercolorlight="#E6E6E6" style="padding:5px;">
                    <tr>
                      <td width="37%" height="95" rowspan="4" align="center"><img src="../images/book/<%=picture%>" width="350" height="350" class="tableBorder_l"></td>
                      <td width="63%" height="40"><%=bookName%></td>
                    </tr>
                    <tr>

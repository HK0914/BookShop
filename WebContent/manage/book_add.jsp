  ...
  <tr>
    ...
    <td align="center" valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td width="1089" align="center" background="images/manage_leftTitle_mid.GIF" class="word_white"><b>添加图书信息</b></td>
			    ...
			    <table width="94%"  border="0" align="center" cellpadding="0" cellspacing="0" bordercolordark="#FFFFFF">
                  <tr>
                    ...
                    <td height="27" colspan="3">&nbsp;
                      <input name="bookName" type="text" class="Sytle_text" id="bookID2" size="50">&nbsp;&nbsp;  </td>
                  </tr>				
                  <tr>
                  ...
                  <tr>
                    ...
                    <td height="41">&nbsp;定　　价：</td>
                    <td height="41">
                          <span style="float:left;"><input name="price" type="text" class="Sytle_text" id="price"></span><span  style="float:left;padding-top:10px;">&nbsp;(元)</span></td>
                  </tr>
                  <tr>

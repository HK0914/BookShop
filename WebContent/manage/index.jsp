  ...
  <tr>
    ...
    <td align="center" valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td width="989" align="center" background="images/manage_leftTitle_mid.GIF" class="word_white"><b>图书列表</b></td>
...
for(int i=1;i<=pagesize;i++){
	  ...
	  %>
              ...
              <tr style="padding:5px;">
                <td height="20" align="center"><a href="book_detail.jsp?ID=<%=ID%>"><%=bookName%></a></td>
                <td align="center" ><%=nowPrice%>元</td>
                <td align="center"><%=newbook%></td>
                <td align="center"><%=sale%></td>
                <td align="center"><a href="book_modify.jsp?ID=<%=ID%>"><img src="images/modify.gif" width="19" height="19"></a></td>
                <td align="center"><a href="book_del.jsp?ID=<%=ID%>"><img src="images/del.gif" width="20" height="20"></a></td>
              </tr>
<%
	try{
		if(!rs.next()){break;}
